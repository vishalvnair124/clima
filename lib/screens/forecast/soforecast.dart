...
class SoForecast extends StatefulWidget {
  const SoForecast({super.key});

  @override
  State<SoForecast> createState() => _SoForecastState();
}

class _SoForecastState extends State<SoForecast> {
  ...
  void getWeather() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        // Extract values
        for (var i = 7; i <= 13; i++) {
          if (decodedData['SO2'] != null &&
              decodedData['SO2'][i.toString()] != null) {
            xValues.add(decodedData['SO2'][i.toString()].toDouble());
          } else {
