...
class PressureAnalysis extends StatefulWidget {
  DateTime date;
  PressureAnalysis({Key? key, required this.date}) : super(key: key);
  @override
  State<PressureAnalysis> createState() => _PressureAnalysisState();
}

class _PressureAnalysisState extends State<PressureAnalysis> {
  ...
  @override
  void didUpdateWidget(PressureAnalysis oldWidget) {
