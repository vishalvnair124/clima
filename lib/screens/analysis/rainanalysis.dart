...
class RainAnalysis extends StatefulWidget {
  DateTime date;
  RainAnalysis({Key? key, required this.date}) : super(key: key);
  @override
  State<RainAnalysis> createState() => _RainAnalysisState();
}

class _RainAnalysisState extends State<RainAnalysis> {
  ...
  @override
  void didUpdateWidget(RainAnalysis oldWidget) {
